...
async function main() {
    ...
    const servicesSeed = [
        {
            ...
            footnotes: '* Up to 5 litres of standard oil included. Certain oil types will incur an additional charge.\n* Additional costs for parts only and will not incur any labour charges.'
        },
        {
            code: 'SERVICE_2',
            name: 'Service 2',
    ...
    const settingsData = {
        ...
        vatRatePercent: new client_1.Prisma.Decimal('20.00'),
        ...
        dvlaApiKey: (_a = process.env.DVLA_API_KEY) !== null && _a !== void 0 ? _a : null,
        dvlaApiKeyEnc: null,
        dvlaApiKeyIv: null,
        dvlaApiKeyTag: null
    };
    ...
    const sequences = [
        { key: client_1.SequenceKey.INVOICE, year: currentYear },
        { key: client_1.SequenceKey.QUOTE, year: currentYear }
    ];
