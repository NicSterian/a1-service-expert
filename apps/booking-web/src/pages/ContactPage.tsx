    ...
    <div className="space-y-16">
        ...
        <div className="relative space-y-6 p-8 sm:p-14">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              className="inline-flex h-11 items-center justify-center rounded-full bg-brand-orange px-6 text-sm font-semibold text-slate-900 transition hover:bg-orange-400"
            >
              Call 07394 433889
            </a>
            <a
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-full border border-brand-orange px-5 text-sm font-semibold text-brand-orange transition hover:bg-brand-orange hover:text-white"
            >
      ...
      <section className="grid gap-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <form className="space-y-4" onSubmit={handleSubmit} noValidate>
          ...
          <div>
            <label className="block text-xs font-semibold uppercase text-slate-600" htmlFor="contact-name">Name</label>
            <input
              id="contact-name"
              value={form.name}
              ...
              className="mt-1 w-full rounded border border-slate-300 px-3 py-2 text-sm focus:border-brand-orange focus:outline-none"
            />
            {fieldErrors.name ? <p id="error-name" className="mt-1 text-xs text-red-600">{fieldErrors.name}</p> : null}
          </div>
          <div>
            <label className="block text-xs font-semibold uppercase text-slate-600" htmlFor="contact-email">Email</label>
            <input
              type="email"
              id="contact-email"
              value={form.email}
          ...
          <div>
            <label className="block text-xs font-semibold uppercase text-slate-600" htmlFor="contact-phone">Phone</label>
            <input
              id="contact-phone"
              value={form.phone}
          ...
          <div>
            <label className="block text-xs font-semibold uppercase text-slate-600" htmlFor="contact-message">Message</label>
            <textarea
              id="contact-message"
              value={form.message}
          ...
          <button
            ...
            className="inline-flex h-11 items-center justify-center rounded bg-brand-orange px-5 text-sm font-semibold text-white transition hover:bg-orange-500 disabled:cursor-not-allowed disabled:opacity-70"
          >
